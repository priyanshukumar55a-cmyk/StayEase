    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-950/95">
      <div className="flex items-center justify-between px-4 py-2 md:px-6 md:py-3">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <ThemeToggle className="h-10 w-10 rounded-full border border-slate-200 bg-white p-0 text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-800" />
  ...
  ${
    hostActive
      ...
      : "bg-blue-600 text-white hover:bg-blue-700"
        ...
        <button
          className="z-50 rounded-xl p-2 transition text-slate-700 hover:bg-slate-200 dark:text-slate-100 dark:hover:bg-slate-800 md:hidden"
        ...
        >
          ...
          >
            {mobileOpen ? (
              <X size={26} className="text-inherit" />
            ) : (
              <Menu size={26} className="text-inherit" />
            )}
          </div>
        </button>
      </div>
      ...
      {mobileOpen && (
        <div className="absolute left-0 right-0 top-full z-50 px-4 md:hidden">
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/98 shadow-2xl backdrop-blur-xl dark:border-slate-700 dark:bg-slate-950/95">
            {isLoggedIn && (
            ...
            <div className="p-2">
              ...
              <div className="mt-3 border-t pt-3">
                <ThemeToggle
                  className="mb-3 w-full justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-950/95 dark:text-slate-100 dark:hover:bg-slate-800 hover:cursor-pointer"
                  showLabel
                />
              </div>
              ...
              {isLoggedIn && user?.userType === "host" && (
                <div className="mt-3 border-t pt-3">
                  <p className="mb-2 px-4 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                    Host
                  </p>
